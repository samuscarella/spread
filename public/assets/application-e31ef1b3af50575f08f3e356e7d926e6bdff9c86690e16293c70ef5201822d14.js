  ...
  $.ajaxSetup({ cache: true });
    $.getScript('//connect.facebook.net/en_US/sdk.js', function() {
       ...
       var beginningOfExpiration;
                      ...
                      if (response.authResponse) {
                         ...
                         $.ajax({
                             ...
                             success: function(data) {
                                ...
                                var daysTillExpiration = Math.ceil(secondsTillExpiration / 86400);
                                console.log('There are ' + daysTillExpiration + ' days left before this token expires.');
                                $('.second-facebook-col').toggleClass("col-md-10").toggleClass("col-md-8"); // decrease size
                                $('.third-facebook-col').toggleClass("col-md-1").toggleClass("col-md-3"); // increase size
                                $('.facebook-accounts-linked-num').html('1');
                                $('#facebook-account-linked-col').html('<h4 style="display:inline-block;margin-bottom:0;margin-right:9px;position:relative;top:5px;"><em>Account Linked</em></h4><img src="./../../assets/checkmark.svg" class="success-check" alt="CHECKMARK"/><h6 style="margin-top:0;color:Crimson;">' + daysTillExpiration + ' days until expiration.</h6>');
                             },
                             error: function(xhr, status, error) {
                    ...
                    $.ajax({
                      ...
                      success: function(data) {
                          ...
                          FB.logout(function(response) {
                                  ...
                                  $('#facebook-account-linked-col').html('<a id="facebook-link-acc" class="btn btn-warning edit-account-btn">+</a>')
        ...
        $(document).on('mouseenter','.success-check', function (e) {
          $('.success-check').replaceWith('<a id="unlink-facebook-account"><img src="./../../assets/x.svg" class="x" alt="X"/></a>');
        }).on('mouseleave', '.x', function(){
          $('.x').replaceWith('<img src="./../../assets/checkmark.svg" class="success-check" alt="CHECKMARK"/>')
          $('#unlink-facebook-account').replaceWith('<img src="./../../assets/checkmark.svg" class="success-check" alt="CHECKMARK"/>');
        });
