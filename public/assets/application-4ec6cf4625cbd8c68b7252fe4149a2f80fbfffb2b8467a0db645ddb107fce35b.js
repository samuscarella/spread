...
$(document).ready(function() {
  $.ajaxSetup({ cache: true });
    $.getScript('//connect.facebook.net/en_US/sdk.js', function() {
      ...
      //      $( this ).replaceWith('<img src="./../../assets/x-hover.svg" class="x" alt="X"/>');
      //    })
      //    .mouseout(function() {
      //      $( this ).replaceWith('<img src="./../../assets/x.svg" class="x" alt="X"/>');
      //    });
          ...
          $.ajax({
            ...
            success: function(tokenString) {
              ...
              if(tokenString) {
                 ...
                 $('#facebook-account-linked-col').html('<h4 style="display:inline-block;margin-bottom:0;margin-right:9px;position:relative;top:5px;"><em>Account Linked</em></h4><img src="./../../assets/checkmark.svg" class="success-check" alt="CHECKMARK"/><a href="#" class="unlink-account"><img src="./../../assets/x.svg" class="x" alt="X"/></a><h6 style="margin-top:0;color:Crimson;">' + daysTillExpiration + ' days until expiration.</h6>');
              } else {
                      ...
                      if (response.authResponse) {
                         ...
                         $.ajax({
                             ...
                             success: function(data) {
                                ...
                                $('.third-facebook-col').toggleClass("col-md-1").toggleClass("col-md-3");
                                $('.facebook-accounts-linked-num').html('1');
                                $('#facebook-account-linked-col').html('<h4 style="display:inline-block;margin-bottom:0;margin-right:9px;position:relative;top:5px;"><em>Account Linked</em></h4><img src="./../../assets/checkmark.svg" class="success-check" alt="CHECKMARK"/><img src="./../../assets/x.svg" class="success-check" alt="X"/><h6 style="margin-top:0;color:Crimson;">' + daysTillExpiration + ' days until expiration.</h6>')
                             },
                             error: function(xhr, status, error) {
        ...
        $('.unlink-account').hover(
                   function () {
                      $(this).html("<img src='./../../assets/x-hover.svg' class='x' alt='X'/>");
                   },
                   function () {
                      $(this).html("<img src='./../../assets/x.svg' class='x' alt='X'/>");
                   }
                );
        $( ".x" ).hover(function() {
            $('.x').remove();
            $('.unlink-account').html('<img src="./../../assets/x-hover.svg" class="x" alt="X"/>');
        });
