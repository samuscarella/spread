          ...
          $.ajax({
            ...
            success: function(tokenString) {
              ...
              if(tokenString) {
                 ...
                 $('#facebook-account-linked-col').html('<h4 style="display:inline-block;margin-bottom:0;margin-right:9px;position:relative;top:5px;"><em>Account Linked</em></h4><img src="./../../assets/checkmark.svg" class="success-check" alt="CHECKMARK"/><a href="#" class="unlink-account"><img src="./../../assets/x.svg" class="x" alt="X"/><h6 style="margin-top:0;color:Crimson;"></a>' + daysTillExpiration + ' days until expiration.</h6>');
              } else {
